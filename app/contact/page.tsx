...
export default function Contact() {
  ...
  const inputClass = 'w-full p-2.5 sm:p-3 border border-gray-300 rounded focus:outline-none focus:border-[#6b7c5d] text-sm sm:text-base'
    ...
    <div className="bg-[#f5f1e8]">
      ...
      <section className="py-12 sm:py-16 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-base sm:text-lg text-gray-700 px-4">Have questions or interested in visiting our farm? Contact us for inquiries about pigs, training programs, or farm visits.</p>
        </div>
      </section>
          ...
          <div>
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="flex items-start gap-3 sm:gap-4">
                <div className="text-[#6b7c5d] flex-shrink-0">
              ...
              <div className="flex items-start gap-3 sm:gap-4">
                <div className="text-[#b8824f] flex-shrink-0">
                  <svg className="w-10 h-10 sm:w-12 sm:h-12" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <div>
                  ...
                  <a href="mailto:info@redwoodhogsfarm.com" className="text-sm sm:text-base text-gray-700 hover:text-[#3d4f3d] transition-colors duration-200">
            ...
            <div className="mt-8 sm:mt-12 bg-white p-5 sm:p-6 rounded-lg shadow-md">
              ...
              <p className="text-xs sm:text-sm text-gray-500 mt-3 sm:mt-4">* Please schedule visits in advance</p>
            </div>
          </div>
          ...
          <div className="bg-white p-6 sm:p-8 rounded-lg shadow-md">
            ...
            {submitted ? (
              <div className="text-center py-12">
                <div className="w-16 h-16 bg-[#e8f0e8] rounded-full flex items-center justify-center text-[#3d4f3d] mx-auto mb-4">
                  <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                    <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/>
                  </svg>
                </div>
                <h3 className="text-xl font-semibold text-[#3d4f3d] mb-2">Message Received!</h3>
                ...
                <button
                  ...
                  className="text-sm text-[#6b7c5d] hover:text-[#3d4f3d] underline transition-colors duration-200"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label htmlFor="name" className="block mb-2 font-semibold text-gray-700 text-sm sm:text-base">Name</label>
                  <input
                    id="name"
                    type="text"
                    name="name"
                ...
                <div>
                  <label htmlFor="email" className="block mb-2 font-semibold text-gray-700 text-sm sm:text-base">Email</label>
                  <input
                    id="email"
                    type="email"
                    name="email"
                ...
                <div>
                  <label htmlFor="phone" className="block mb-2 font-semibold text-gray-700 text-sm sm:text-base">Phone <span className="text-gray-400 font-normal">(optional)</span></label>
                  <input
                    id="phone"
                    type="tel"
                    name="phone"
                ...
                <div>
                  <label htmlFor="message" className="block mb-2 font-semibold text-gray-700 text-sm sm:text-base">Message</label>
                  <textarea
                    id="message"
                    name="message"
                ...
                <button
                  type="submit"
                  className="w-full bg-[#6b7c5d] text-white px-6 py-2.5 sm:py-3 rounded hover:bg-[#5a6b4d] transition-colors duration-200 font-semibold text-sm sm:text-base"
                >
                  Send Message
                </button>
              </form>
