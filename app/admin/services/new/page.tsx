...
export default function NewServicePage() {
  ...
  return (
    <div className="max-w-2xl">
      <Link href="/admin/services" className="text-sm text-gray-500 hover:text-gray-700 mb-4 inline-flex items-center gap-1">
        ← Back to Services
      </Link>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <input id="title" type="text" value={form.title}
              ...
              className={inputClass} placeholder="e.g. Breeding Stock Supply" />
          ...
          <div>
            ...
            <textarea id="description" value={form.description}
              ...
              rows={3} className={inputClass} placeholder="Describe this service…" />
          </div>

          <div>
            <label htmlFor="icon_svg" className="block text-sm font-medium text-gray-700 mb-1">
              Icon SVG <span className="text-gray-400 font-normal">(optional — paste raw SVG markup)</span>
            </label>
            <textarea id="icon_svg" value={form.icon_svg}
              onChange={(e) => setForm({ ...form, icon_svg: e.target.value })}
              rows={4} className={`${inputClass} font-mono text-xs`}
